...
namespace TexturePlugin
{
    ...
    public class ImportTextureOption : UABEAPluginOption
    {
        ...
        */
        /*
        private bool ImportTextures(List<ImportBatchInfo> batchInfos)
        {
            StringBuilder errorBuilder = new StringBuilder();
        ...
        public class ExportTextureOption : UABEAPluginOption
    {
        ...
        public bool ExecutePlugin(string path,AssetWorkspace workspace, List<AssetContainer> selection)
        {
            ...
            if (selection.Count > 1)
            {
                return await BatchExport(workspace, selection);
            }
            else
            */
                return SingleExport(path,workspace, selection);
        }
        ...
        */
        ...
        public bool SingleExport(string path,AssetWorkspace workspace, List<AssetContainer> selection)
        {
            AssetContainer cont = selection[0];
    ...
    public bool SelectionValidForPlugin(AssetsManager am, UABEAPluginAction action, List<AssetContainer> selection, out string name)
    {
        ...
        */
        ...
        public bool ExecutePlugin(string path,AssetWorkspace workspace, List<AssetContainer> selection)
        {
            ...
            EditConsole consoleLoad=new EditConsole(texFile.m_Name, texFile, texBaseField);

            consoleLoad.LoadTexture(path);
